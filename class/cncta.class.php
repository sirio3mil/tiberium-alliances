...
class TiberiumAlliances
{
    ...
    public function login($user, $password=null, $lang=null)
    {
      ...
      curl_setopt($ch, CURLOPT_URL, 'https://www.tiberiumalliances.com/es/login/j_security_check');
      ...
      //$ch = curl_init();
      $urlL = 'https://www.tiberiumalliances.com/es/game/launch';
      curl_setopt($ch,CURLOPT_URL,$urlL);
      curl_setopt($ch, CURLOPT_REFERER, 'https://www.tiberiumalliances.com/es/login/auth');
      curl_setopt($ch, CURLOPT_COOKIEFILE, $this->cookie);
      curl_setopt($ch, CURLOPT_COOKIEJAR,  $this->cookie);
      curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
      curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
